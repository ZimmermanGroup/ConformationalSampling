...
# Otherwise you can define it here also by uncommenting next line
 FC = icpc -openmp -I/export/zimmerman/paulzim/openbabel241/include/openbabel-2.0/ \
                   -I/export/zimmerman/paulzim/bcat/eigen2/
...
LINKERFLAGS =  -L$(MKLROOT)/lib/intel64 -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -lpthread -lm -L/export/zimmerman/paulzim/openbabel241/lib/ \
              -L/export/zimmerman/paulzim/openbabel241/lib/openbabel/2.4.1/ -lopenbabel
#MacOS link 
